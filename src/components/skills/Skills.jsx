...
const skills = [
  ...
  { logo: expressLogo, title: "ExpressJs", desc: "nodeJS Framework" },
];

const Skills = () => {
  return (
    <div id="Skills" className="text-left px-36 py-32 pb-48">
      ...
      <div className="flex flex-row flex-wrap gap-5 py-10 justify-center">

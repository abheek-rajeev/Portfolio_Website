...
const VisibleTextLayer = ({ text, torch, handleTorchClick }) => {
  ...
  return (
    <>
      <div className="absolute w-full h-screen flex flex-col justify-center items-start gap-2 text-white z-20 pointer-events-none max-w-5xl overflow-hidden px-36">
        ...
        <h2 className="text-3xl font-bold pt-5">Full-stack Developer</h2>
      ...
      <button
        className="absolute right-36 bottom-20 text-black px-2 py-2 bg-yellow-300  rounded-full w-10 h-10 flex items-center justify-center z-40"
        onClick={() => {
